        ...
        <div className=" mx-10">
          ...
          <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
            ...
            <div className="mt-10">
              ...
              <p className="mt-4 md:ml-4 ml-0 ">
                ...
                leaders, NGO representatives, and government officials from
                Health and Human Resource Ministries. Despite organising into
                nine working groups to pursue advocacy objectives, the
          ...
          <div className="py-3 mt-10 mx-0 md:mx-10 border rounded-2xl bg-[#f8cf2c] ">
            <p className=" mx-2 md:mx-7">
              ...
              refugees in Malaysia. Despite challenges faced in the past, ReAct
              has taken steps to strengthen their organization through capacity
              building and leadership training, demonstrating their commitment
              to creating lasting change for the refugee community.
            </p>
          </div>
        </div>
      </div>
